...
let message :string = "Areeba Ahmed Khan";
console.log(`${message}`);
...
let userName:string = "Areeba Ahmed Khan";  //string datatype
console.log(`${userName}`);

let classRoom:number = 5;
let students:number  = 20;  //number datatype
let teachers:number  = 10;

console.log(`${classRoom + students + teachers}`);
//let phoneNumber:number =31128717
//console.log(phoneNumber);
//boolean datatype
let phoneNumber:boolean = true;  //boolean datatyoe
console.log(`${phoneNumber}`);

let email:any = "asho1234$@gmail.com"; //any datatype
console.log(email);
...
let beforeShopping:number = 10000;
let afterShopping:number  = 2000;
...
const accountNumber:number = 123456789; //here i use const because account balance is always constant
 let accountBlance = 5000; // i use let variable because balance change any time
 let leftBalance = 2000;
 let totalAccountbalance:number = 3000;
